...
public class PriorityQueueDemo {
    public static void main(String[] args) {
        ...
        minHeap.add(20);
        minHeap.add(40);
        //System.out.println("큐 상태 (삽입 후): " + minHeap);//10, 20 ,30, 50, 40
        //50이 들어가요
        //10이 들어가요
        //30이 들어가요
        //20이 들어가요
...
//
            // 4. 가장 작은 값 제거 (poll)
        System.out.println("\n[가장 작은 값 제거]");
        System.out.println("제거된 값 (poll): " + minHeap.poll());//10 제거된다
        System.out.println("큐 상태 (제거 후): " + minHeap);//[20,40,30,50]
       // [x,20,30,50,40] 10이 제거된 상태
        //[40,20,30,50]
